  ...
  return (
    ...
    >
      ...
      <article className="flex w-full flex-col gap-8 overflow-hidden xl:h-96 xl:flex-row">
        <div className="flex flex-col rounded-2xl bg-green-700 px-4 sm:px-0 md:flex-row md:gap-8 xl:w-2/3">
          <div className="mt-10 flex flex-col justify-center gap-4 text-center sm:mx-10 md:mx-0 md:ml-10 md:w-1/2 md:text-left">
            <h2 className="m-auto text-center text-3xl font-semibold text-gray-300 sm:w-[18ch] md:m-0 md:text-left">
              Pay with PayMint, quick, simple and easy
            </h2>
            <p className="m-auto text-center text-white sm:w-[34ch] md:m-0 md:text-left">
              Paying your bills has never been easier on PayMint. Whether you
              are paying for electricity or internet, PayMint gets it done
              within seconds.
            </p>
          </div>

          <div className="m-auto mt-10 max-w-72 md:mx-10 md:w-1/2 lg:mx-0">
            <img src={AppFrame} alt="PayMint app frame" />
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center gap-4 rounded-2xl bg-indigo-100 p-10 xl:w-1/3">
          ...
          <p className="text-gray-500">
            Your money is 100% safe and secure on PayMint. No hassles, no
      ...
      <article className="flex w-full flex-col gap-8 xl:h-96 xl:flex-row">
        <div className="flex flex-col justify-center gap-4 rounded-2xl bg-orange-100 p-10 xl:w-1/3">
          ...
          <p className="text-gray-500">
            PayMint reduced payments maintenance and processing fees. No hidden
            fees.
          </p>
        </div>

        <div className="flex flex-col gap-8 overflow-hidden rounded-2xl bg-zinc-600 px-4 sm:px-0 md:flex-row md:gap-8 xl:w-2/3">
          <div className="mt-10 flex flex-col justify-center gap-4 text-center sm:mx-10 md:mx-0 md:ml-10 md:mt-0 md:w-1/2 md:text-left">
            <h2 className="m-auto text-center text-3xl font-semibold text-gray-200 sm:w-[18ch] md:m-0 md:text-left">
              Send, receive and Exchange money
            </h2>
            <p className="m-auto text-center text-gray-100 sm:w-[34ch] md:m-0 md:text-left">
             Payments all work on PayMint, including transfers. Get your alert message
