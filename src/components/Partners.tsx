  ...
  return (
    <section id="partners" className="mt-20 flex flex-col bg-gray-50 py-20">
      <article className="mb-10 w-full px-8 text-center lg:px-12">
        ...
        <p>
          <span className="text-green-600">PayMint</span> allows you to connect your other accounts to seamlessly. <span className="text-green-600">PayMint</span> supports
          200+
          <br />
