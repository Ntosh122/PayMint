...
import financeLogo from "../assets/logos/logo.png";
        ...
        <>
          <div className="flex h-[15vh] max-w-7xl items-center justify-between px-8 lg:px-12 xl:m-auto">
            <div className="flex">
              <ButtonLink
                href="#"
                children={<img src={financeLogo} alt="Kobodrop logo" width={200} height={200}/>}
              />
            ...
            <ButtonLink
              ...
              target="_blank"
              children={"Install PayMint"}
              className="active:bg hidden rounded-xl bg-green-600 px-5 py-3 text-white hover:bg-gray-900 active:bg-gray-600 sm:flex"
            />
